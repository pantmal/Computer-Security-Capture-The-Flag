...
Το request_y.py αρχείο στα Plan_Y_files εκτελεί, όπως και στο προηγούμενο request.py, όλες τις απαραίτητες ενέργειες για το χτήσιμο του attack string που μας δίνει πίσω το z.log αρχείο (είτε με τον κατάλληλο αποσχολιασμό τα αρχεία backup.log και index.html). Ομοίως το run_2.sh εκτελεί το επιθημητό attack.
